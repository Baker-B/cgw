...
const dataEncryptor = (dataToEncrypt, passphrase="sself") => {
    const cert = new crypto.X509Certificate(fs.readFileSync("../../client/src/userCert/user_1_cert.pem"))
...
const privateKey = fs.readFileSync("../../client/src/userCert/user_1_key.pem")
